                ...
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">البيانات الخاصة  بتعديل الملف الشخصي</h3>
							...
							<div class="col-12 p-2 row">
								<div class="col-6 pt-3 ">
                                    <div class="col-12">
                                        ...
                                        <br>
                                    <div class="col-12">
                                    <input type="text" name="first_name" required min="3" max="190" class="form-control" value="{{auth()->user()->first_name}}" accept="image/*">
								</div>
                                ...
                                <div class="col-6 pt-3 ">
                                    <div class="col-12">
                                        ...
                                        <br>
                                        <div class="col-12">
                                            <input type="text" name="last_name" required min="3" max="190" class="form-control" value="{{auth()->user()->last_name}}" accept="image/*">
                                        </div>
