...
@section('title')
    المهارات-تعديل المشرف
@endsection
@section('content-title')
    بيانات الخاصة بتعديل المشرف
@endsection
@section('content')
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> تعديل  مشرف </h3>
                </div>
            </div>
            <div class="card-body">
		<form id="validate-form" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.supervisors.update',$user->id)}}">
		@csrf
		@method("PUT")
